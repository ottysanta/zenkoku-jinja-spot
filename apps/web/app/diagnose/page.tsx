  ...
  "@graph": [
    {
      ...
      "description": "生年月日と今の悩みから、五行属性・干支・数秘誕生数を導き出し、あなたに縁深い守護神社を診断するツール。全国46,000社以上のデータベースから最適な神社を提案。",
      ...
      "mainEntity": [
        {
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "守護神社診断は、生年月日（十干十二支・五行属性）と数秘術誕生数、今抱えている悩みを組み合わせて、あなたに縁深い守護神社を特定するオリジナルの診断システムです。全国46,000社以上のデータベースから、あなたの属性とご利益が一致する神社を紹介します。"
          }
        },
        {
          "@type": "Question",
        ...
        {
          "@type": "Question",
          "name": "数秘術誕生数と神社参拝の関係は？",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "数秘術の誕生数は生年月日の全桁を1桁に還元した数字（1〜9、マスターナンバー11・22・33）で、その人の魂の特質と人生テーマを示します。誕生数7（真理の探究者）なら七の数に縁深い神社や霊験あらたかな神秘的な聖地との相性が深く、誕生数1（先駆者）なら開拓・創始を象徴する神様をお祀りする神社との縁が強くなります。"
          }
        },
        {
          "@type": "Question",
        ...
        },
        {
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "ご利益別では、仕事運・勝負運なら八幡宮・鹿島神宮系、恋愛・縁結びなら出雲大社系・月読神社系、家族・夫婦円満なら住吉大社系、金運・商売繁盛なら稲荷系神社（伏見稲荷など）が代表的です。ただし最適な神社はあなたの五行属性・誕生数によっても変わるため、守護神社診断で個人に合った神社を確認することをお勧めします。"
          }
        },
        {
          "@type": "Question",
