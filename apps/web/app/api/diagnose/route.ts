...
const NUMEROLOGY: Record<number, NumerologyData> = {
  ...
  9: {
    ...
    essence: "あなたは「すべてを完成へと導く」魂の持ち主です。数秘術で最も大きな数である誕生数9は、多くの経験と魂の成長を経てきた古い魂の証です。個人の利益を超えてより大きな視点で人々に貢献することに真の喜びを感じます。手放すことの美しさを知っている稀有な存在です。",
  ...
  33: {
    ...
    name: "無条件の愛の体現者",
    keyword: "奉仕・癒し・無条件の愛",
    essence: "あなたは数秘術最高位のマスターナンバー33を持つ「無条件の愛を体現する師」です。誕生数33は最も稀少なマスターナンバーであり、深い癒しと愛を世界にもたらすために生まれてきた魂です。条件なく愛する力と誰の痛みにも寄り添える共感力は人間の限界を超えています。",
